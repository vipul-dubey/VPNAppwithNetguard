...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    const char *packet = "inc/bitwise/vpnapp/Packet";
    clsPacket = jniGlobalRef(env, jniFindClass(env, packet));

    const char *allowed = "inc/bitwise/vpnapp/Allowed";
    clsAllowed = jniGlobalRef(env, jniFindClass(env, allowed));

    const char *rr = "inc/bitwise/vpnapp/ResourceRecord";
    clsRR = jniGlobalRef(env, jniFindClass(env, rr));

    const char *usage = "inc/bitwise/vpnapp/Usage";
...
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1init(
...
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1start(
...
JNIEXPORT void JNICALL
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1run(
...
JNIEXPORT void JNICALL
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1stop(
...
JNIEXPORT void JNICALL
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1clear(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
    clear(ctx);
}
...
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}

JNIEXPORT jintArray JNICALL
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1get_1stats(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
...
JNIEXPORT void JNICALL
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1pcap(
...
JNIEXPORT void JNICALL
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1socks5(JNIEnv *env, jobject instance, jstring addr_,
...
JNIEXPORT void JNICALL
Java_inc_bitwise_vpnapp_ServiceSinkhole_jni_1done(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
...
Java_inc_bitwise_vpnapp_Util_jni_1getprop(JNIEnv *env, jclass type, jstring name_) {
    const char *name = (*env)->GetStringUTFChars(env, name_, 0);
...
Java_inc_bitwise_vpnapp_Util_is_1numeric_1address(JNIEnv *env, jclass type, jstring ip_) {
    jboolean numeric = 0;
...
void log_packet(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Linc/bitwise/vpnapp/Packet;)V";
...
void dns_resolved(const struct arguments *args,
    ...
    const char *signature = "(Linc/bitwise/vpnapp/ResourceRecord;)V";
...
struct allowed *is_address_allowed(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Linc/bitwise/vpnapp/Packet;)Linc/bitwise/vpnapp/Allowed;";
...
void account_usage(const struct arguments *args, jint version, jint protocol,
    ...
    const char *signature = "(Linc/bitwise/vpnapp/Usage;)V";
